<template>
  <div class="app-container">
    ...
    >
      ...
      <vxe-table-column field="paperYear" title="考试年度"></vxe-table-column>
      <vxe-table-column
        field="contestNo"
        title="竞赛名称"
...
<script>
  import { listContestpaper, delContestpaper, exptContestpaper } from '@/api/labsys/contestpaper'
...
export default {
  ...
  methods: {
    ...
    handleDel() {
      ...
      if (selectedRecords.length > 0) {
        this.$layer.confirm("您确定要删除所选的记录吗？",(layerid)=> {
          ...
          delContestpaper(selectedRowKeys).then((response) => {
            that.getDataSource();
    ...
    handleExport() {
      ...
      exptContestpaper(this.pageParam).then((response) => {
    ...
    getDataSource() {
      ...
      this.loading = true;
      this.pageParam.dataParams = this.queryParams;
      listContestpaper(this.pageParam).then((response) => {
