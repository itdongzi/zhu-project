<template>
  <div class="app-container">
    ...
    >
      ...
      <vxe-table-column field="roomName" title="实训室名称"></vxe-table-column>
      ...
      ></vxe-table-column>
      <vxe-table-column field="roomScale" title="实训室规模"></vxe-table-column>
      <vxe-table-column title="操作">
        <template v-slot="{ row }">
          <vxe-button type="text" status="primary" @click="handleEdt(row.roomNo)"
            >编辑</vxe-button
          >
          <vxe-button type="text" status="primary" @click="handleDet(row.roomNo)"
            >详细</vxe-button
          >
        </template>
      </vxe-table-column>
