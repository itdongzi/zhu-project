<template>
  <div class="app-container">
    ...
    >
      ...
      <vxe-table-column field="groupNo" title="小组名称"></vxe-table-column>
      <vxe-table-column
        field="userNo"
        title="报名学生"
      ...
      <vxe-table-column title="操作">
        <template v-slot="{ row }">
          <vxe-button type="text" @click="handleEdt(row.enrollNo)"
            >审核</vxe-button
          >
          <vxe-button type="text" @click="handleDet(row.enrollNo)"
            >详细</vxe-button
          >
        </template>
      </vxe-table-column>
