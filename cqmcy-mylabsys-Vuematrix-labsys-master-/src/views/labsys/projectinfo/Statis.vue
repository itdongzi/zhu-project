<template>
  <div class="app-container">
    ...
    >
      ...
      <vxe-table-column field="classNo" title="项目分类"></vxe-table-column>
      <vxe-table-column
        field="publishDate"
        title="立项时间"
      ...
      <vxe-table-column title="操作">
        <template v-slot="{ row }">
          <vxe-button type="text" @click="handleEdt(row.projectNo)"
            >编辑</vxe-button
          >
          <vxe-button type="text" @click="handleDet(row.projectNo)"
            >详细</vxe-button
          >
        </template>
      </vxe-table-column>
