package com.benet.framework.web.domain;
...
public class Server
{
    ...
    private void setSysInfo()
    {
        ...
        sys.setComputerName(IpnetUtils.getHostName());
        sys.setComputerIp(IpnetUtils.getHostIp());
    ...
    private void setSysFiles(OperatingSystem os)
    {
        ...
        for (OSFileStore fs : fsArray)
        {
            ...
            sysFile.setUsage(ArithmetUtils.mul(ArithmetUtils.div(used, total, 4), 100));
