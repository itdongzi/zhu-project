...
public class LabsDeviceclassController extends BaseController
{
    ...
    {
        LoginUser loginUser = tokenService.getLoginUser(ServletUtils.getRequest());
        return AjaxResult.success(labsDeviceclassService.getRecordByNo(loginUser.getAppCode(),id));
    }
    ...
    {
        LoginUser loginUser = tokenService.getLoginUser(ServletUtils.getRequest());
        LabsDeviceclass info= labsDeviceclassService.getRecordByNo(loginUser.getAppCode(),id);
