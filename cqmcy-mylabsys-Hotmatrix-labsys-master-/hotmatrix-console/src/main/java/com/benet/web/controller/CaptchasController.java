...
import com.benet.web.vmodel.CodeImgInfo;
...
public class CaptchasController
{
    ...
    public AjaxResult getCodeImage() throws IOException
    {
        // 生成随机字串
        ...
        try
        {
            CodeImgInfo code=new CodeImgInfo(uuid,Base64Utils.encode(stream.toByteArray()));
